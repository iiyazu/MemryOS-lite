...
- `xmuse/master_blueprint.md`
- `xmuse/master_config.json`
- `xmuse/work/features/`
- `xmuse/master/`
- `xmuse/approvals/`

Legacy root-loop files under `xmuse/legacy/root-loop/` remain audit-only.
...
- Old `xmuse-architecture.html`.
- Obsolete `xmuse/phases/README.md`.
...
- `xmuse/history/main_loop_phase0_18.md`
- `xmuse/history/main_loop_phase0_18.json`
...
Tests should not depend on `xmuse/work/phase-*` directories.
