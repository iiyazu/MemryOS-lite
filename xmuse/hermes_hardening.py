...
def _allowed_target_branches(loop: Path) -> list[str] | None:
...
def validate_merge_queue_gate(loop_root: str | Path, feature: dict[str, Any]) -> dict[str, Any]:
    ...
    allowed_target_branches = _allowed_target_branches(loop)
    if allowed_target_branches is not None and target_branch not in allowed_target_branches:
