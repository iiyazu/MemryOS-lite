...
The tables below are bounded historical smoke results, not claims about the
current full suite or general answer quality. Re-run the commands before using
them as comparison evidence.
