...
Plan review: `.hermes-loop/work/phase-12/plan_review.md`.
...
Write `.hermes-loop/work/phase-12/red_result.md` with the command, failing assertion or traceback summary, and interpretation that same-session archival eligibility is not yet wired.
...
Include the first-line phase binding, active goal, context bundle path, changed chain components, RED result, verification commands, and a statement that no LongMemEval/LoCoMo improvement is claimed.

- [ ] **Step 2: Write `execute_review.md`**

Answer what real chain changed, what remains demo-only or partial, which tests proved behavior, which benchmark cases moved or regressed, and whether v1 fallback, v3 default, and kernel opt-in remain intact.

- [ ] **Step 3: Write `case_matrix.md`**

Record LongMemEval and LoCoMo as `limit=0`, `not_applicable`, no claim, unless public benchmark context/reporting files were changed. Keep Phase 11 LoCoMo debt visible: `conv-26_qa_028`, `conv-26_qa_005`, `conv-26_qa_003`, `conv-26_qa_004`, `conv-26_qa_006`, `conv-26_qa_008`, `conv-26_qa_016`, `conv-26_qa_019`, `conv-26_qa_020`, `conv-26_qa_024`, `conv-26_qa_025`.
