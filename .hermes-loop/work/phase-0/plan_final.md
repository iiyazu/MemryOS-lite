...
This approved plan follows `.hermes-loop/work/phase-0/context_bundle.md`, `.hermes-loop/work/phase-0/brainstorm.md`, `.hermes-loop/work/phase-0/spec.md`, and `.hermes-loop/work/phase-0/god_dispatch.json`. It keeps Phase 0 as a no-code baseline freeze unless a required diagnostic is missing, in which case the only allowed escalation is one focused failing test and an `adjust` decision.
...
Do not modify `src/`, `tests/`, `docs/`, `.hermes-loop/state.json`, `.hermes-loop/blueprint.md`, review verdict artifacts, or ACK artifacts unless diagnostics are proven missing and the plan explicitly enters the focused failing-test branch. Even then, production behavior optimization remains out of scope and execution must stop with `adjust` unless a later dispatch authorizes implementation.

## Step 1: RED Evidence

- [ ] Re-read `.hermes-loop/work/phase-0/context_bundle.md`, `.hermes-loop/work/phase-0/brainstorm.md`, `.hermes-loop/work/phase-0/spec.md`, and `.hermes-loop/work/phase-0/god_dispatch.json`.
...
- [ ] Cite `.hermes-loop/work/phase-0/context_bundle.md`, `.hermes-loop/work/phase-0/brainstorm.md`, `.hermes-loop/work/phase-0/spec.md`, and `.hermes-loop/work/phase-0/god_dispatch.json`.
...
- any source, docs, blueprint, state, review verdict, or ACK file is changed outside the allowed boundary;
