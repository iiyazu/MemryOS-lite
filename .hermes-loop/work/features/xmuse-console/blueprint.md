...
Status: planned.
Feature lane: `.hermes-loop/work/features/xmuse-console/`.
...
Use live code, `AGENTS.md`, `consensus.md`, `.hermes-loop/master_state.json`,
`.hermes-loop/master_status.json`, `.hermes-loop/contracts/*.json`, and
`.hermes-loop/prompts/*_god_prompt.md` as current facts.
...
- `.hermes-loop` is the current Master/Slave control plane.
...
- `.hermes-loop/contracts/master_dispatch_template.json` and
  `.hermes-loop/contracts/slave_dispatch_template.json` define required inputs,
  allowed writes, forbidden actions, required artifacts, and gates.
- `.hermes-loop/contracts/state_machine.json` is deprecated and must be shown as
...
- A local-only, read-only xmuse snapshot adapter for `.hermes-loop`.
- Stable xmuse DTOs that shield the frontend from `.hermes-loop` schema drift.
...
- Hermetic tests using fixture directories, not the current live `.hermes-loop`
...
- xmuse is read-only. No UI control or API endpoint may write `.hermes-loop`,
  git state, MemoryOS data, approvals, or runtime process state.
- `.hermes-loop/master_state.json` remains the current control-plane source of
...
- SQLite remains authoritative for MemoryOS memory. xmuse only observes
  `.hermes-loop` and repository/runtime state.
...
- Tests must use hermetic fixtures under `tests/fixtures/xmuse/`. They must not
  assert against the current live `.hermes-loop` state as a durable expectation.
...
- `.hermes-loop/work/features/xmuse-console/blueprint.md`
- `.hermes-loop/work/features/xmuse-console/slave_state.json`
- `.hermes-loop/work/features/xmuse-console/context_bundle.md`
- `.hermes-loop/work/features/xmuse-console/brainstorm.md`
- `.hermes-loop/work/features/xmuse-console/plan.md`
- `.hermes-loop/work/features/xmuse-console/plan_final.md`
- `.hermes-loop/work/features/xmuse-console/phase-*/result.md`
- `.hermes-loop/work/features/xmuse-console/phase-*/execute_review.md`
- `.hermes-loop/work/features/xmuse-console/phase-*/ack.json`
- `.hermes-loop/work/features/xmuse-console/phase-*/review_verdict.json`
- `.hermes-loop/work/features/xmuse-console/result.md`
- `.hermes-loop/work/features/xmuse-console/execute_review.md`
- `.hermes-loop/work/features/xmuse-console/ack.json`
- `.hermes-loop/work/features/xmuse-console/review_verdict.json`

Master-owned gate artifacts:

- `.hermes-loop/master/features/xmuse-console/master_review.json`
- `.hermes-loop/master/features/xmuse-console/integrated_tests.json`
- `.hermes-loop/approvals/xmuse-console/merge_approval_request.json`
- `.hermes-loop/approvals/xmuse-console/merge_approval.json`
- `.hermes-loop/approvals/xmuse-console/merge_decision.json`
- `.hermes-loop/approvals/xmuse-console/post_merge_verification.json`
...
Build the read-only adapter that converts `.hermes-loop` fixture state into a
...
the current live `.hermes-loop` as a durable expectation.
...
- Frontend never reads `.hermes-loop` raw files.
...
- Frontend reads `.hermes-loop` raw files directly instead of xmuse DTOs.
...
- Tests depend on the current live `.hermes-loop` state instead of fixtures.
...
- blueprint: `.hermes-loop/work/features/xmuse-console/blueprint.md`
- slave_state: `.hermes-loop/work/features/xmuse-console/slave_state.json`
- context_bundle: `.hermes-loop/work/features/xmuse-console/context_bundle.md`
- brainstorm: `.hermes-loop/work/features/xmuse-console/brainstorm.md`
- plan: `.hermes-loop/work/features/xmuse-console/plan.md`
- plan_final: `.hermes-loop/work/features/xmuse-console/plan_final.md`
- phase results: `.hermes-loop/work/features/xmuse-console/phase-*/result.md`
- phase execute reviews:
  `.hermes-loop/work/features/xmuse-console/phase-*/execute_review.md`
- phase ACKs: `.hermes-loop/work/features/xmuse-console/phase-*/ack.json`
- phase review verdicts:
  `.hermes-loop/work/features/xmuse-console/phase-*/review_verdict.json`
- feature result: `.hermes-loop/work/features/xmuse-console/result.md`
- execute_review: `.hermes-loop/work/features/xmuse-console/execute_review.md`
- feature ack: `.hermes-loop/work/features/xmuse-console/ack.json`
- feature review verdict:
  `.hermes-loop/work/features/xmuse-console/review_verdict.json`
- master_review: `.hermes-loop/master/features/xmuse-console/master_review.json`
- integrated_tests:
  `.hermes-loop/master/features/xmuse-console/integrated_tests.json`
- merge_approval_request:
  `.hermes-loop/approvals/xmuse-console/merge_approval_request.json`
- merge_approval: `.hermes-loop/approvals/xmuse-console/merge_approval.json`
- merge_decision: `.hermes-loop/approvals/xmuse-console/merge_decision.json`
